...
class FirstTier : public Basebill
{
public:
	FirstTier(int AccountNumber, std::string CustomerName, int number);//constructor function that initializes the account number, customer name and irrigaton number
...
private:
	 std::string Tier1; // attribute field that stores the number of times the irrigation is done in the week
};